...
def debug_transaction(connection: BaseDatabaseWrapper, sql: str) -> Generator[None, None, None]: ...
def split_tzname_delta(tzname: str) -> tuple[str, None, None] | tuple[str, str, str]: ...
@overload
